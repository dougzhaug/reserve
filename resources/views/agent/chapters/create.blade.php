...
@section('content')
    <form class="form-horizontal" action="{{url('chapters/'.request('goods_id'))}}" method="post">
        {{ csrf_field() }}
        ...
        <div class="form-group {{ $errors->has('files') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-9">
                @uploader(['name' => 'files', 'max'=>100, 'accept' => 'jpg,png,gif,txt,pdf'])
                {{-- 文件上传 --}}
                @uploader('assets')
                @if ($errors->has('files'))
        ...
        <div class="form-group {{ $errors->has('summary') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-9">
                <textarea name="summary" class="form-control" rows="5" placeholder="简介">{{old('summary')}}</textarea>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input name="sort" type="text" value="{{ old('sort') }}" class="form-control" id="inputSort" placeholder="排序"> </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                ...
                {{-- Radio 单选框插件 --}}
                @include('layouts.plugins.Radio',['name'=>'charge','style'=>'info','level'=>1,'radio'=>[['name'=>'免费','value'=>0],['name'=>'收费','value'=>1,'checked'=>true]]])
            </div>
        </div>
